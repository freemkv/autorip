...
# 5. Verify
curl http://rip.docker.internal.localhost/api/state
```
...
curl http://rip.docker.internal.localhost/api/system
```
...
- Use (removed) UI: https://(removed).docker.internal.localhost
