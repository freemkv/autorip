...
- Version aligned to 1.6.15 for the unified release. Documentation fixes (build-from-source instructions) and internal CI/lint hardening; no functional changes.
